...
class CSP(object):
    ...
    * var_to_const, a variable to set of constraints dictionar """
    ...
    def show(self, linewidth=3, showDomains=False, showAutoAC=False, title=None):
        ...
        self.draw_graph(domains=domains, title=title)
    ...
    def draw_graph(self, domains={}, to_do={}, title=None, fontsize=10):
        ...
        self.autoACtext = plt.text(0, 0, "Auto AC" if self.showAutoAC else "",
                                   bbox={'boxstyle': 'square', 'color': 'yellow'}, picker=True, fontsize=fontsize)
        ...
        for con in self.constraints:
            ...
            for var in con.scope:
                ...
                if (var, con) in to_do:
                    ...
                    color = 'limegreen'
                line = lines.Line2D([cx, vx], [cy, vy], axes=self.ax, color=color, picker=True, pickradius=10,
